...
public class AvatarController {
    ...
    public ResponseEntity<String> uploadAvatar(@PathVariable Long id, @RequestParam MultipartFile cover) throws Exception {
    ...
    // метод возвращает уменьшенную копию загруженного изображения
    ...
    // метод возвращает оригинал, который загрузил пользователь
